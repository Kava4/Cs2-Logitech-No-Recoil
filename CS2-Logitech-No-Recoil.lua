...
function OnEvent(event, arg)
    -- Dynamic recoil strength (Logitech G-keyboard G8 / G9). Change arg if needed.
    if (event == "G_PRESSED" and arg == 8) then
        InGameSens = math.max(0.1, InGameSens - 0.1)
        Sens = 2.0 / InGameSens
        OutputLogMessage("Increased Recoil Compensation (InGameSens: " .. InGameSens .. ")\n")
        return
    elseif (event == "G_PRESSED" and arg == 9) then
        InGameSens = InGameSens + 0.1
        Sens = 2.0 / InGameSens
        OutputLogMessage("Decreased Recoil Compensation (InGameSens: " .. InGameSens .. ")\n")
        return
    end
